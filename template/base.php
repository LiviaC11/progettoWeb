...
<nav class="navbar navbar-expand-lg bg-dark sticky-top navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold " href="index.php" aria-label="CoHappy - Torna alla Home">🏠 CoHappy</a>
            <!--
                data-bs-toggle serve per dire a js di far partire l'effetto collapse
                data-bs-target invece dice quale classe prendere 
            -->
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-label="Apri menù di navigazione">
